  ...
  useEffect(() => {
    ...
    const draw = (currentTime) => {
      ...
      const sampleCount = Math.floor(
        (2 * (bWidth + bHeight) + 2 * Math.PI * radius) / 2,
      );
      ctx.beginPath();
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-[inherit] pointer-events-none z-0">
        <div
          className="absolute inset-0 rounded-[inherit] border-2 opacity-60 blur-[1px]"
          style={{ borderColor: hexToRgba(color, 0.6) }}
        />
        <div
          className="absolute inset-0 rounded-[inherit] border-2 blur-[4px]"
          style={{ borderColor: color }}
        />
        <div
          className="absolute inset-0 rounded-[inherit] -z-[1] scale-110 opacity-20 blur-[32px]"
          style={{
